...
export default {
  ...
  deleteProduct(productId) {
    return Vue.http.delete(API_BASE_URL + '/' + productId, {
      headers: { Authorization: $store.state.auth.token },
    })
  },
  ...
  releaseProduct(productId) {
    return Vue.http.get(API_BASE_URL + '/' + productId + '/release', {
      headers: { Authorization: $store.state.auth.token },
    })
  },

  repostProduct(productId) {
    return Vue.http.get(API_BASE_URL + '/' + productId + '/repost', {
      headers: { Authorization: $store.state.auth.token },
    })
  },

  hideProduct(productId) {
    return Vue.http.get(`${API_BASE_URL}/${productId}/hide`, {
      headers: { Authorization: $store.state.auth.token },
    })
  },

  searchProduct(params) {
    return Vue.http.post(API_BASE_URL + '/search', params, {
      headers: { Authorization: $store.state.auth.token },
    })
  },
  ...
  acceptCollaboration(productId) {
    return Vue.http.get(
      API_BASE_URL + '/' + productId + '/accept_collaboration',
      { headers: { Authorization: $store.state.auth.token } }
    )
  },
  ...
  denyCollaboration(productId) {
    return Vue.http.get(
      API_BASE_URL + '/' + productId + '/deny_collaboration',
      { headers: { Authorization: $store.state.auth.token } }
    )
  },

  orderedItems(productId, params) {
    return Vue.http.get(`${API_BASE_URL}/${productId}/ordered_items`, {
      headers: { Authorization: $store.state.auth.token },
      params: params,
    })
  },
  ...
  tickets(productId, params) {
    return Vue.http.get(`${API_BASE_URL}/${productId}/tickets`, {
      headers: { Authorization: $store.state.auth.token },
      params: params,
    })
  },
