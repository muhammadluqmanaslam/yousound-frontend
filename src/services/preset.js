...
export default {
  ...
  loadPreset (presetId) {
    return Vue.http.get(`${API_BASE_URL}/${presetId}/load`, { headers: { 'Authorization': $store.state.auth.token } })
  },

  deletePreset (presetId) {
    return Vue.http.delete(`${API_BASE_URL}/${presetId}`, { headers: { 'Authorization': $store.state.auth.token } })
  }
}
