        ...
        <div class="normal-tab">
          <v-tabs dark v-model="tab">
            <v-tabs-bar class="transparent">
              <v-tabs-item key="suggested" href="#suggested" ripple
                >Suggested Reposters</v-tabs-item
              >
              <v-tabs-item
                key="current"
                href="#current"
            ...
            <v-layout row wrap class="search-section" v-if="tab == 'suggested'">
              ...
              <v-flex sm2 mx-1>
                <v-btn class="search-btn" @click.native="searchUsers()"
                  >Search</v-btn
                >
              </v-flex>
            </v-layout>
            <v-tabs-items>
              <v-tabs-content key="suggested" id="suggested">
                <v-card flat>
                  <v-layout row wrap>
                    ...
                    <v-flex sm2 class="header-title text-xs-left pl-2"
                      >User</v-flex
                    >
                    <v-flex sm2 class="header-title">Followers</v-flex>
                    <v-flex sm2 class="header-title">Price</v-flex>
                    <v-flex sm3 class="header-title text-xs-left px-2"
                      >Recent Reposts</v-flex
                    >
                  ...
                  <div class="user-list-section">
                    ...
                    >
                      ...
                      <v-flex sm2>
                        <p class="repost-price">
                          ${{ user.repost_price | formatNumber }}
                        </p>
                      </v-flex>
                      <v-flex sm3>
              ...
              <v-tabs-content key="current" id="current">
                <v-card flat>
                  <v-layout row wrap>
                    <v-flex sm1 class="header-title"></v-flex>
                    <v-flex sm3 class="header-title text-xs-left pl-2"
                      >User</v-flex
                    >
                    <v-flex sm2 class="header-title">Followers</v-flex>
                    <v-flex sm2 class="header-title">Price</v-flex>
                    <v-flex sm2 class="header-title text-xs-left px-2"
                      >Actual Reach(Plays)</v-flex
                    >
                  ...
                  <div class="total-section">
                    <div class="cost-section px-3">
                      ...
                      <p class="value">
                        ${{ current_values.total_paid | formatNumber }}
                      </p>
                    </div>
                    <div class="total-potential-section px-3">
                      <p class="title mb-1">Total Potential Reach</p>
                      <p class="value">
                        {{ current_values.total_potential_reach }}
                      </p>
                    </div>
                    <div class="cost-section px-3">
                      <p class="title mb-1">Total Actual Reach</p>
                      <p class="value">
                        {{ current_values.total_actual_reach }}
                      </p>
                    </div>
                    <div class="total-potential-section px-3">
