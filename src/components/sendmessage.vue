  ...
  <v-flex xs12 sm12 class="direct-message-section">
    ...
    <v-layout row class="popup-section">
      <v-flex
        ...
        :class="{
          sm7: $store.state.auth.user.user_type == 'artist',
          sm12: $store.state.auth.user.user_type != 'artist',
        }"
      >
        <div
          class="avatar-image"
          :style="{
            'background-image': 'url(' + receiver.avatar.thumb.url + ')',
          }"
        ></div>
        <p class="user-name">
          {{ receiver.username }}
          <v-icon
            ...
            v-if="receiver.user_type == 'artist'"
        ...
        <label
          ...
          >Repost Price: ${{ receiver.repost_price | formatNumber }}</label
        >
      ...
      <v-flex
        ...
        v-if="$store.state.auth.user.user_type == 'artist'"
        :class="{
          sm5: $store.state.auth.user.user_type == 'artist',
          sm12: $store.state.auth.user.user_type != 'artist',
        }"
      >
