      ...
      <v-flex xs12 class="promote-album-section">
        ...
        <div class="content-section">
          <div class="promote-album-image">
            ...
            <div class="promote-image" :style="{'background-image': 'url(' + itemCover + ')'}"></div>
          ...
          <div class="promote-album-description">
            ...
            <v-btn class="promote-btn" flat @click.native="showPromoteModal()">Promote this album</v-btn>
          </div>
          <div class="promote-album-action">
          </div>
        </div>
      </v-flex>
...
<script type="text/javascript">
  ...
  export default {
    ...
    methods: {
      ...
      onCopy: function (e) {
        this.$store.dispatch('error/showSuccessToast', ['You just copied: ' + e.text])
