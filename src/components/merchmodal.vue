    ...
    <v-layout row wrap class="popup-section">
      <v-flex xs12 sm7 class="image-section" v-if="!showPolicySection">
        ...
        <div
          ...
          :style="{
            'background-image': 'url(' + covers[0].cover.url + ')',
      ...
      <v-flex xs12 sm12 class="policy-section" v-if="showPolicySection">
        <v-tabs fixed centered>
          <v-tabs-bar dark>
            ...
            <v-tabs-item key="size_chart" href="#size_chart"
              >Size Chart</v-tabs-item
            >
            <v-tabs-item key="shipping_policy" href="#shipping_policy"
              >Shipping Policy</v-tabs-item
            >
            <v-tabs-item key="return_policy" href="#return_policy"
              >Return Policy</v-tabs-item
            >
            <v-tabs-item key="privacy_policy" href="#privacy_policy"
              >Privacy Policy</v-tabs-item
            >
          </v-tabs-bar>
          <v-tabs-items>
      ...
      <v-flex xs12 sm12 class="actions-section">
        <div class="action-btn-wrapper">
          <div class="action-btn policy" @click="togglePolicy()">
            <span>{{ policyButtonText }}</span>
          </div>
        </div>
        <div class="action-btn-wrapper">
          <div class="action-btn repost" @click="repostProduct()">
            <v-chip>
              <svg
                height="20px"
                viewBox="0 0 24 20"
              ...
              >
                ...
                >
                  <g
                    id="23---Merch-Modal"
                    transform="translate(-818.000000, -773.000000)"
                    fill="#3A92FF"
                  >
                    <g
                      id="Group-4"
            ...
            <v-chip>
              ...
              >
                ...
                >
                  <g
                    id="23---Merch-Modal"
                    transform="translate(-1090.000000, -771.000000)"
                    fill-rule="nonzero"
                    fill="#3A92FF"
                  >
                    <g
