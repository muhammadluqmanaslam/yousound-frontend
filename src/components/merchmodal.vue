    ...
    <v-layout row wrap class="popup-section">
      <v-flex xs12 sm7 class="image-section" v-if="!showPolicySection">
        ...
        <div v-if="covers.length == 1"
          ...
          :style="{'background-image': 'url(' + covers[0].cover.url + ')', 'background-repeat': 'no-repeat', 'background-size': 'contain'}"></div>
      ...
      <v-flex xs12 sm12 class="actions-section">
        ...
        <div class="action-btn-wrapper">
          <div class="action-btn repost" @click="repostProduct()">
            <v-chip>
              <svg height="20px" viewBox="0 0 24 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <!-- Generator: Sketch 46.2 (44496) - http://www.bohemiancoding.com/sketch -->
                  <desc>Created with Sketch.</desc>
                  <defs></defs>
                  <g id="Design" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <div v-if="shareProduct" @click="shareProduct()" class="action-btn share">
            <v-chip>
              <svg height="20px" viewBox="0 0 19 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <!-- Generator: Sketch 46.2 (44496) - http://www.bohemiancoding.com/sketch -->
                  <desc>Created with Sketch.</desc>
                  <defs></defs>
                  <g id="Design" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
