<template>
  <v-layout row wrap class="user-item">
    ...
    <v-flex xs12 sm10 offset-sm1 class="user-item-body" v-bind:class="{'last-item': last}">
      <v-layout row wrap>
        <v-flex xs12 class="user-item-section"  v-bind:class="{'sm6': userItem.recent_reposts, 'no-reposts': !userItem.recent_reposts}">
            ...
            <div class="user-item-content-area">
              ...
              <div class="actions-section">
                <v-btn
                  ...
                  v-if="userItem.id!=$store.state.auth.user.id"
