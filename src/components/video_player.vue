            ...
            <v-toolbar class="header">
              ...
              <v-tooltip bottom>
                <v-btn
                  icon
                  slot="activator"
                  @click.native="choosePage('discover')"
                >
                  <svg
                    width="20px"
                    height="22px"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <g
                          id="07---Discover"
                          transform="translate(-1508.000000, -64.000000)"
                          fill="#FFFFFF"
                        >
                          <path
                            d="M1529.6,64 L1510.4,64 C1509.08,64 1508,65.0788576 1508,66.3974614 L1508,86.3083785 C1508,86.9233273 1508.744,87.2314011 1509.1796,86.7962619 L1512.8,83.1796913 L1529.6,83.1796913 C1530.92,83.1796913 1532,82.1008337 1532,80.7822299 L1532,66.3974614 C1532,65.0788576 1530.92,64 1529.6,64"
                            id="ic_inbox"
                            transform="translate(1520.000000, 75.500000) scale(-1, 1) translate(-1520.000000, -75.500000) "
                          ></path>
                        </g>
                      </g>
                    </svg>
              ...
              <v-badge color="red">
                <span
                  slot="badge"
                  v-if="$store.state.activity.badge.cart > 0"
                  >{{ $store.state.activity.badge.cart }}</span
                >
                <v-tooltip bottom>
                  <v-btn
                    icon
              ...
              <v-badge color="red">
                <span
                  slot="badge"
                  v-if="$store.state.activity.badge.sell > 0"
                  >{{ $store.state.activity.badge.sell }}</span
                >
                <v-tooltip bottom>
                  <v-btn
                    icon
              ...
              >
                <v-btn
                  icon
                  slot="activator"
                  @click.native="player.fullscreen()"
                >
                  <div
                    class="profile-image"
                    :style="{
