        ...
        <v-card-title class="headline">
          <div class="dflex gap-15">
            ...
            <div class="headline-text">
              Your {album, video, product} was released! <a href="#">Upload another</a> or go to <a href="#">upload page</a> 
            </div>
          </div>
        </v-card-title>
          ...
          <div class="dflex gap-20">
            ...
            <div class="w-70">
              <div>
                ...
                <p class="mb-0 second-head">Artist name</p>
                <p class="light-text">12 tracks</p>
                <p class="light-text">Genre: R&B / Soul</p>
