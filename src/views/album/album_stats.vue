    ...
    <v-flex xs12 sm10 offset-sm1 class="album-section" v-if="isPageReady">
      ...
      <div class="album-info-section">
        ...
        <div class="album-detail-section">
          ...
          <p class="album-stats">
            <span>{{ album.stats.reposts_size | formatLargeNumber }}</span
            ><label>Reposts</label>
            <span>{{ album.stats.downloads_size | formatLargeNumber }}</span
            ><label>Downloads</label>
            <span>{{ album.stats.plays_size | formatLargeNumber }}</span
            ><label>Plays</label>
            <span>{{ album.stats.hides_size | formatLargeNumber }}</span
            ><label>Hides</label>
          </p>
        </div>
      </div>
