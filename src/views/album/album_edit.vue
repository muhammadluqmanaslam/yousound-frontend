  ...
  <v-layout row wrap class="page upload-album-page">
    <v-flex xs12 relative v-if="isPageReady">
      ...
      <v-flex xs12 album-info-section v-if="album.tracks.length" id="album_info_section">
        ...
        <v-flex xs12 class="additional-info-section" v-if="['pending', 'collaborated'].indexOf(album.status) != -1">
          <v-flex xs12>
            <v-layout>
      ...
      <v-dialog v-model="show_collaborators_confirm_dialog" content-class="collaborators-confirm-dialog">
        <v-card>
