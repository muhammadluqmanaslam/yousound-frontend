<template>
  <div class="page auth-page auth-register-page artist">
    <div class="text-xs-center">
      ...
      <h4>Sign Up as Label</h4>
    </div>

    <div class="info-section">
      <div class="info-title">Labels can</div>
      <div class="info-description pt-3">
        - Link to Verified Artists & build a roster
      </div>
    ...
    <div class="register-section">
      <form v-on:submit.prevent="submit()">
        ...
        <v-flex xs12 text-xs-left>
          <label class="field-title">Label Name (ie. Super Cool Records)</label>
          <input
            class="displayname"
            type="text"
            name="display_name"
...
<script type="text/javascript" src="./register_by_label.ctrl.js"></script>
