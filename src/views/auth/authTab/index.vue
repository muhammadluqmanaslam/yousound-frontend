<template>
  <div class="auth-tab allChildrenCenter minHeightScreen">
    ...
    <v-container tab-container>
        <div v-if="inviteMode" class="invite-info" :class="{inviteMode: inviteMode}">
            ...
            <v-flex xs4 bodyContent :class="{inviteMode: inviteMode}">
                <div v-if="activeTab == 'everyone'" class="bodyContent everyone">
                    ...
                    <div class="__subheadline">
                        <div class="__subheadline_text">Join thousands of music lovers</div>
                    </div>

                    <div class="sideLists">
                        <div
                            v-for="(list, i) in sideLists"
                            :key="i"
                            class="sideList"
                        >
                ...
                <div v-else-if="activeTab == 'artistBrand'" class="bodyContent artistBrand invited">
                    <div class="__headline">
                        <span>Signup to YouSound</span>
                    </div>

                    <div class="__subheadline">
                        <div class="__subheadline_text">The best place for Artists & Brands.</div>
                    </div>
