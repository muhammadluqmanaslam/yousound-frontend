<template>
  <v-layout row wrap>
    <v-flex xs12 sm6 offset-sm3  md6 offset-md3 lg8 offset-lg2 xl8 offset-xl2>
      ...
      <div class="article js-hide-during-search page terms-page">
          ...
          <div class="article-body content-body wikistyle markdown-format">
              ...
              <h3>
                <a id="the-YouSound.com-terms-of-service" class="anchor" href="#the-YouSound.com-terms-of-service" aria-hidden="true">
              ...
              <h3>
                <a id="c-acceptable-use" class="anchor" href="#c-acceptable-use" aria-hidden="true">
                  <span aria-hidden="true" class="octicon octicon-link"></span>
                </a>C. Acceptable Use
              </h3>
              ...
              <h4>
                <a id="4-services-usage-limits" class="anchor" href="#4-services-usage-limits" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>4. Services Usage Limits
              </h4>
              ...
              <h4>
                <a id="2-YouSound.com-may-remove-content" class="anchor" href="#2-YouSound.com-may-remove-content" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>2. YouSound.com May Remove Content</h4>
              ...
              <h4>
                <a id="3-ownership-of-content-right-to-post-and-license-grants" class="anchor" href="#3-ownership-of-content-right-to-post-and-license-grants" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>3. Ownership of Content, Right to Post, and License Grants</h4>
              ...
              <h3>
                <a id="e-private-repositories" class="anchor" href="#e-private-repositories" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>E. Private Repositories</h3>
              ...
              <h4>
                <a id="1-control-of-private-repositories" class="anchor" href="#1-control-of-private-repositories" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>1. Control of Private Repositories.</h4>

              <p>Some accounts, such as paid accounts, may have private repositories, which allow the User to control access to Content.</p>

              <h4>
                <a id="2-confidentiality-of-private-repositories" class="anchor" href="#2-confidentiality-of-private-repositories" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>2. Confidentiality of Private Repositories.</h4>
              ...
              <h4>
                <a id="3-access" class="anchor" href="#3-access" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>3. Access.</h4>
              ...
              <h4>
                <a id="4-exclusions" class="anchor" href="#4-exclusions" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>4. Exclusions.</h4>
              ...
              <h3>
                <a id="f-copyright-infringement-and-dmca-policy" class="anchor" href="#f-copyright-infringement-and-dmca-policy" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>F. Copyright Infringement and DMCA Policy</h3>
              ...
              <h3>
                <a id="g-intellectual-property-notice" class="anchor" href="#g-intellectual-property-notice" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>G. Intellectual Property Notice</h3>
              ...
              <h4>
                <a id="1-YouSound.coms-rights-to-content" class="anchor" href="#1-YouSound.coms-rights-to-content" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>1. YouSound.com's Rights to Content</h4>
              ...
              <h4>
                <a id="2-YouSound.com-trademarks-and-logos" class="anchor" href="#2-YouSound.com-trademarks-and-logos" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>2. YouSound.com Trademarks and Logos</h4>
              ...
              <h4>
                <a id="3-license-to-YouSound.com-policies" class="anchor" href="#3-license-to-YouSound.com-policies" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>3. License to YouSound.com Policies</h4>
              ...
              <h3>
                <a id="h-api-terms" class="anchor" href="#h-api-terms" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>H. API Terms</h3>
              ...
              <h4>
                <a id="no-abuse-or-overuse-of-the-api" class="anchor" href="#no-abuse-or-overuse-of-the-api" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>No Abuse or Overuse of the API</h4>
              ...
              <h3>
                <a id="i-additional-terms-for-YouSound.com-pages" class="anchor" href="#i-additional-terms-for-YouSound.com-pages" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>I. Additional Terms for YouSound.com Pages</h3>
              ...
              <h3>
                <a id="j-additional-terms-for-YouSound.com-marketplace" class="anchor" href="#j-additional-terms-for-YouSound.com-marketplace" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>J. Additional Terms for YouSound.com Marketplace</h3>
              ...
              <h3>
                <a id="k-advertising-on-YouSound.com" class="anchor" href="#k-advertising-on-YouSound.com" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>K. Advertising on YouSound.com</h3>
              ...
              <h4>
                <a id="1-YouSound.com-pages" class="anchor" href="#1-YouSound.com-pages" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>1. YouSound.com Pages</h4>
              ...
              <h4>
                <a id="2-YouSound.com-repositories" class="anchor" href="#2-YouSound.com-repositories" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>2. YouSound.com Repositories</h4>
              ...
              <h4>
                <a id="3-spamming-and-inappropriate-use-of-YouSound.com" class="anchor" href="#3-spamming-and-inappropriate-use-of-YouSound.com" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>3. Spamming and Inappropriate Use of YouSound.com</h4>
              ...
              <h3>
                <a id="l-payment" class="anchor" href="#l-payment" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>L. Payment</h3>
              ...
              <h3>
                <a id="m-cancellation-and-termination" class="anchor" href="#m-cancellation-and-termination" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>M. Cancellation and Termination</h3>
              ...
              <h4>
                <a id="3-YouSound.com-may-terminate" class="anchor" href="#3-YouSound.com-may-terminate" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>3. YouSound.com May Terminate</h4>
              ...
              <h3>
                <a id="n-communications-with-YouSound.com" class="anchor" href="#n-communications-with-YouSound.com" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>N. Communications with YouSound.com</h3>
              ...
              <h4>
                <a id="2-legal-notice-to-YouSound.com-must-be-in-writing" class="anchor" href="#2-legal-notice-to-YouSound.com-must-be-in-writing" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>2. Legal Notice to YouSound.com Must Be in Writing</h4>
              ...
              <h3>
                <a id="o-disclaimer-of-warranties" class="anchor" href="#o-disclaimer-of-warranties" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>O. Disclaimer of Warranties</h3>
              ...
              <h3>
                <a id="p-limitation-of-liability" class="anchor" href="#p-limitation-of-liability" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>P. Limitation of Liability</h3>
              ...
              <h3>
                <a id="q-release-and-indemnification" class="anchor" href="#q-release-and-indemnification" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Q. Release and Indemnification</h3>
              ...
              <h3>
                <a id="r-changes-to-these-terms" class="anchor" href="#r-changes-to-these-terms" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>R. Changes to These Terms</h3>
              ...
              <h3>
                <a id="s-miscellaneous" class="anchor" href="#s-miscellaneous" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>S. Miscellaneous</h3>
...
<script type="text/javascript" src="./terms_of_service.ctrl.js"></script>
