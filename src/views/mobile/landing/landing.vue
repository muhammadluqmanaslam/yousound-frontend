<template>
  <div class="landing-page">
    ...
    <a
      href="//apps.apple.com/us/app/id1452078262"
      target="_blank"
      class="download"
      ><img src="/static/images/img_download_ios.svg" height="50"
    /></a>
  </div>
</template>
...
/*
 *   YouSound Gradient Remix - WebGl Gradient Animation
 *.  Inspired by Stripe Gradient
 *   All credit to Stripe.com
 */
...
#gradient-canvas {
  ...
  --gradient-color-2: #234235;
  --gradient-color-3: #928337;
  --gradient-color-4: #324362;
}
</style>
