<template>
  <div class="main-section">
    ...
    <table style=" font-family: 'Open Sans',sans-serif; font-size: 16px; border-collapse: collapse">
<<<<<<< Updated upstream
      <tbody>
        <tr>
        ...
        <tr>
          ...
          <td style="border: 1px solid #d7d7d7; padding: 16px">
            Log into your account, play your own songs, and use the download button on the footer player to download&nbsp;your songs
          </td>
        </tr>
        <tr>
          <td style="border: 1px solid #d7d7d7; padding: 16px">
...
=======
							<tbody>
							<tr>
								<td style="border: 1px solid #d7d7d7; padding: 16px; background-color: #eee"> 
									<strong> If you want to:</strong>
								</td>
								<td style="border: 1px solid #d7d7d7; padding: 16px; background-color: #eee"> 
									<strong> Do this:</strong>
							...
							<tr>
								<td style="border: 1px solid #d7d7d7; padding: 16px">  
									 Close your account and delete your profile information Note: If you close your account, YouSound may retain other information about you for the activities described in our Privacy Policy, or as permitted or required by applicable law.
								</td>
								<td style="border: 1px solid #d7d7d7; padding: 16px">  
									 Go&nbsp; 
									<a href="http://www.yousound.com/settings">here</a>, to the&nbsp;“Settings”, then click "cancel my account"<br>
      ...
      <p><br>Residents of the European Economic Area (“EEA”) can exercise certain data subject rights available to them under applicable data protection laws.  If you are an EEA resident and wish to exercise one of these rights, please e-mail: privacy@yousound.com. </p>
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
    <p>We may request you provide us with information necessary to confirm your identity (such as your IP address, date of birth, transaction IDs, and email address) before responding to your request.<br><br></p>
=======
      <p>We may request you provide us with information necessary to confirm your identity (such as your IP address, date of birth, transaction IDs, and email address) before responding to your request.<br><br></p>
      ...
      <table style=" font-family: 'Open Sans',sans-serif; font-size: 16px; border-collapse: collapse">
							<tbody>
							<tr>
								<th style="border: 1px solid #d7d7d7; padding: 16px; font-size: 18px; text-align: left; background-color: #eee">   
									 If you want to:
								</th>
								<th style="border: 1px solid #d7d7d7; padding: 16px; font-size: 18px; text-align: left; background-color: #eee"> 
									 Do this:
							...
							<tr>
								...
								<td style="border: 1px solid #d7d7d7; padding: 16px">  
									Go 
									<a href="http://www.yousound.com/settings">here</a>, to “Settings”, then click "cancel my account". Your information is permanently deleted within 30 days, view our Terms of Use clause "Closing Your Account" to see the specifics.<br>
								</td>
							</tr>
							<tr>
								<td style="border: 1px solid #d7d7d7; padding: 16px">  
							...
							<tr>
								<td style="border: 1px solid #d7d7d7; padding: 16px">  
			closi						 Transfer your personal information to a third-party provider of services
								</td>
								<td style="border: 1px solid #d7d7d7; padding: 16px">  
...
>>>>>>> Stashed changes
    ...
    <table style=" font-family: 'Open Sans',sans-serif; font-size: 16px; border-collapse: collapse">
      <tbody>
        <tr>
          <th style="border: 1px solid #d7d7d7; padding: 16px; font-size: 18px; text-align: left">
            If you want to:
          </th>
          <th style="border: 1px solid #d7d7d7; padding: 16px; font-size: 18px; text-align: left">
            Do this:
