<template>
  <div class="main-section">
    ...
    <p>YouSound, Inc. ("Company") has adopted the following general policy toward claims of infringement with respect to intellectual property owned or controlled by third parties in accordance with the  Digital Millennium Copyright Act.</p>

    <p>It is Company's policy to</p>

    <li>block access to or remove material that it believes in good faith to be the intellectual property of a third party (e.g., copyrights, trademarks, trade secrets, etc.) that has been illegally copied and distributed by any of our advertisers, affiliates, content providers, members or users; and</li>

    <li>remove and discontinue service to repeat offenders. A repeat infringer is a user for whom YouSound has received more than two notices of claimed infringement or for which YouSound has had to remove content more than twice. Notwithstanding the preceding sentence, YouSound reserves the right to immediately terminate the account of any user for egregious infringing activities in YouSound's sole determination and discretion.</li>
    ...
    <li>If claiming copyright infringement, the statement "I swear under penalty of perjury that I am the copyright owner or am authorized to act on behalf of the owner of an exclusive right that is allegedly infringed, and that the information in this notification is accurate. I have a good faith belief that use of the copyrighted materials described above as allegedly infringing is not authorized by the copyright owner, its agent, or the law."</li>

    <p> Note that a copy of your legal notice will be forwarded to the party responsible for providing the alleged infringing content.  Please do not include any information in your report other than the above items.</p>
