<template>
	<div class="main-section">
		...
		<div class="article-body content-body wikistyle markdown-format">
			...
			<li><strong>Financial information,</strong> such as Stripe account(s) and payouts.</li>

			<li><strong>Buyer & Seller information,</strong> such as the user-provided name, email address, country of residence, zip/postal code, picture, location, and biography.</li>

			<li><strong>Emails and messages,</strong> including receipts, newsletters, and support contact. This information consists of the emails we send to individuals, and the messages that users may send to one another.</li>

			<p>In addition to the above, we may automatically collect the following types of information:</p>

			<li><strong>Website activity information,</strong> such as application logs, data files, information collected by cookies, IP address, browser information, and metrics generated in the normal operation of a website. “Application logs” are text files in which are recorded most of the activities on a website, including page visits, payments, and usage. Website activity information is sometimes associated with an IP address or other Personal Data. Third parties may also collect information about your website activity over time and on other websites or mobile applications.</li>

			<li><strong>Information collected via cookies.</strong> Cookies are alphanumeric identifiers that we transfer to your computer’s hard drive through your browser to enable our systems to recognize your browser and tell us how and when pages in our site are visited and by how many people. YouSound cookies do not collect Personal Data, and we do not combine the general information collected through cookies with other Personal Data to tell us who you are or what your screen name or email address is. Most browsers have an option for turning off the cookie feature, which will prevent your browser from accepting new cookies, as well as (depending on the sophistication of your browser software) allowing you to decide on acceptance of each new cookie in a variety of ways. We strongly recommend that you leave the cookies activated, however, because cookies enable you to take advantage of some of YouSound’s most attractive features. If you choose to disable cookies or similar technologies, some parts of our Service may not work properly.</li>

			<li><strong>We use Google Analytics</strong> to collect and process analytical data about users of YouSound’s website. Google Analytics tracks your interaction with the Site and stores information about IP address, operating system, web browser, pages visited, information about demographics of our website users, the device used, and where the visit originated. You can learn about Google’s practices by going to https://www.google.com/policies/privacy/partners/, and opt out of them by downloading the Google Analytics opt-out browser add-on, available at https://tools.google.com/dlpage/gaoptout.</li>

			<li>We may use software tools such as JavaScript to collect page interaction information such as clicks, drags, and hover-overs, response times, errors, and length of visits to certain pages.</li>

			<h3>For Which Purposes Will YouSound Use Your Personal Data?</h3>

			<p>The Personal Data collected by YouSound is used for the following purposes:</p>

			<li>To allow you to use the Service, to set up a user account and profile that can be used to interact with other users, and to allow users to identify each other by displaying Personal Data to other users and visitors of the Service;</li>

			<li>To provide, administer, and communicate with you about products, services, offers, programs, and promotions of YouSound and its partners (including surveys and any other marketing activities). If required under applicable law, we will only send you promotional communications with your consent;</li>

			<li>To operate, evaluate and improve our business, including developing new products and services; managing our communications; determining the effectiveness of, and optimizing the content you see; analyzing our products, services, website, mobile application, and any other digital assets; facilitating the functionality of our website, mobile application, and any other digital assets;</li>
			...
			<li>In connection with prospective service engagements, partnerships or vendor relationships;</li>
			...
			<li>To protect the rights, property, or safety of YouSound, our employees, our users, or others, including by taking measures to prevent fraud and reduce credit risk;</li>
			...
			<p><strong>Email Communications:</strong> We may receive a confirmation when you open an email from YouSound. YouSound uses this confirmation to help us make emails more interesting and helpful and improve our service. If you do not want to receive email from us, please contact us as specified in the “How To Contact Us” section below.</p>

			<h3>When Does YouSound Collect Personal Data Relating To You?</h3>

			<p>We may collect and use Personal Data relating to you when:</p>
			...
			<li>Your use of YouSound’s Service;</li>
			...
			<h3>How Will YouSound Share the Personal Data It Receives?</h3>

			<p>Personal Data about our customers is an integral part of our business. We neither rent nor sell your Personal Data to anyone. We share your Personal Data only as described below.</p>

			<li><strong>Members of our Group:</strong> We may share your Personal Data with any members of our group, which includes our affiliates, employees, subsidiaries and branch offices, to which it is reasonably necessary or desirable for us to disclose your data in order to carry out the above-mentioned data processing purposes.</li>

			<li><strong>Affiliated Businesses We Do Not Control:</strong> We are affiliated with a variety of businesses and work closely with them. In certain situations, these businesses sell items to you through YouSound's Service. In other situations, YouSound provides services, or sells products jointly with affiliated businesses. You can easily recognize when an affiliated business is associated with your transaction, and we will share your Personal Data that is related to such transactions with that affiliated business.</li>
			...
			<li><strong>Aggregate information:</strong> We may provide aggregate information to our partners about how our customers, collectively, use our site. We share this type of statistical data so that our partners also understand how often people use their services and our Service, so that they, too, may provide you with an optimal online experience. YouSound never discloses aggregate information to a partner in a manner that would identify you personally.</li>

			<li><strong>Communication in response to User Submissions:</strong> As part of the Service and Services, you will receive from Company email and other communication relating to your User Submissions. You acknowledge and agree that by posting such User Submissions, Company may send you email and other communication that it determines in its sole discretion relate to your User Submissions.</li>

			<li><strong>Business Transfers:</strong> In these types of transactions, customer information is typically one of the business assets that is transferred. Moreover, if YouSound, or substantially all of its assets were acquired, or in the unlikely event that YouSound goes out of business or enters bankruptcy, customer information would be one of the assets that is transferred or acquired by a third party. You acknowledge that such transfers may occur, and that any acquirer of YouSound may continue to use your Personal Data as set forth in this policy.</li>

			<li><strong>Compliance with the Law, Protection of YouSound and Others:</strong> We may access, preserve, and disclose collected information, if we believe doing so is required or appropriate to: comply with law enforcement requests and legal process, such as a court order or subpoena; enforce or apply our conditions of use and other agreements; or protect the rights, property, or safety of YouSound, our employees, our users, or others. This includes exchanging information with other companies and organizations for fraud protection and credit risk reduction.</li>

			<li><strong>With Your Consent:</strong> Except as set forth above, you will be notified when your Personal Data may be shared with third parties, and will be able to prevent the sharing of this information.</li>

			<h3>Is Personal Data About You Secure?</h3>

			<p>YouSound endeavors to protect user information to ensure that your Personal Data is kept private. We use physical, managerial, and technical security measures to protect your Personal Data against accidental or unlawful destruction, loss, alteration, unauthorized disclosure or access. In particular, we take steps to ensure that our employees and service providers who have access to your Personal Data only process it upon our instructions, unless otherwise required by law.</p>

			<p>However, no measures are 100% secure and unauthorized entry or use, hardware or software failure, and other factors, may compromise the security of your Personal Data. To protect the security of your data, you need to select and protect your password appropriately and limit access to your computer and browser by signing off after you have finished accessing your account.</p>

			<p>The Service may contain links to other sites. YouSound is not responsible for the privacy policies and/or practices on other sites. When linking to another site you should read the privacy policy stated on that site. This Privacy Policy only governs information collected by YouSound.</p>

			<h3>What Choices And Rights Do You Have Regarding Your Personal Data?</h3>

			<p>You have certain rights regarding the Personal Data we maintain about you. We also offer you certain choices about what Personal Data we collect from you, how we use that information, and how we communicate with you.</p>

			<li>Sometimes you may be required by law or by contract to provide us with your Personal Data to be able to use our products or services. In other cases, you may provide us with your personal data voluntarily. The particular reasons for using your Personal Data, whether you are required to provide your Personal Data, and the possible consequences of not providing your Personal Data will be indicated at the time the information is collected.</li>

			<li>You may designate certain User Submissions as private so that they are not shared with other users. Not all User Submissions may be designated as private.</li>

			<li>You can add or update certain information on pages, such as your username and password, your email address, and your user profile information.</li>

			<li>Where required by law, we obtain your prior opt-in consent at the time of collection for certain processing of Personal Data, such as for direct marketing purposes. If we rely on consent for the processing of your Personal Data, you have the right to withdraw your consent at any time and, when you do so, this will not affect the lawfulness of the processing before your consent withdrawal.</li>

			<li>You can opt out of the collection and use of certain information, which we collect about you by automated means, when you visit our website. Your browser may tell you how to be notified and opt out of receiving certain types of cookies and similar technologies. Please note, however, that without cookies you may not be able to use all of the features of our website.</li>

			<li>You can at any time tell us not to send you marketing communications by email by clicking on the unsubscribe link within the marketing emails you receive from us or by contacting us as specified in the “How To Contact Us” section below. Please note that if you do not want to receive legal notices from us, such as this Privacy Policy, those legal notices will still govern your use of the YouSound Service, and you are responsible for reviewing such legal notices for changes.</li>

			<li>To the extent provided by applicable law, you may withdraw any consent you previously provided to us, or object at any time on legitimate grounds, to the processing of your Personal Data. We will apply your preferences going forward. In some circumstances, withdrawing your consent to the use or disclosure of your Personal Data will mean that you cannot take advantage of some YouSound features.</li>

			<li>Subject to applicable law, you may have the right to: obtain confirmation that we hold Personal Data about you, request access to and receive information about the Personal Data we maintain about you, receive copies of the Personal Data we maintain about you, exercise your right to data portability, update and correct inaccuracies in your Personal Data, object to or restrict the processing of your Personal Data, and have the information blocked, anonymized or deleted, as appropriate. These rights may be limited in some circumstances by local law requirements. You may also have the right to lodge a complaint with your local data protection authority.</li>

			<li>Under California’s “Shine the Light” law, California residents who provide Personal Data in obtaining products or services for personal, family, or household use are entitled to request and obtain from us once a calendar year information about the customer information we shared, if any, with other businesses for their own direct marketing uses. If applicable, this information would include the categories of customer information shared, the names and email addresses of those businesses with which we shared customer information for the immediately prior calendar year (e.g., requests made in 2018 will receive information regarding 2017 sharing activities), and descriptions of the likely types of marketing the third parties would send. Please be aware that not all information sharing is covered by the “Shine the Light” requirements and only information on covered sharing will be included in our response.</li>

			<li>If we fall short of your expectations in processing your Personal Data or you wish to make a complaint about our privacy practices, please tell us because it gives us an opportunity to fix the problem. You may contact us by using the contact details provided in the “How To Contact Us” section below. To assist us in responding to your request, please give full details of the issue. We attempt to review and respond to all complaints within a reasonable time.</li>

			<li>If you provide us with any Personal Data relating to another individual, you should make sure that the sharing with us and our further use as described to you from time to time is in line with applicable laws, so for example you should duly inform that individual on the processing of her/his Personal Data and obtain her/his consent, as may be necessary under applicable laws.</li>

			<li>To exercise your rights and choices as described above, please contact us as specified in the “How To Contact Us” section below.</li>

			<h3>Does YouSound Collect Children's Data?</h3>

			<p>We do not knowingly collect, maintain, or use Personal Data from children under 13 years of age, and no part of the Service is directed to children under the age of 13. If you learn that your child has provided us with Personal Data without your consent, you may alert us by using the contact details provided in the “How To Contact Us” section below. If we learn that we have collected any Personal Data from children under 13, we will promptly take steps to delete such information and terminate the child’s account.</p>

			<h3>Does YouSound Transfer Your Personal Data Abroad?</h3>
