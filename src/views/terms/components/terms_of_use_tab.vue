<template>
  <div class="main-section">
    ...
    <div class="article-body content-body wikistyle markdown-format">
      ...
      <h3>
        <a id="3-modification" class="anchor" href="#3-modification" aria-hidden="true">
      ...
      <ul>
        <li><strong>infringes any patent, trademark, trade secret, copyright, right of publicity or other right of any other person or entity or violates any law or contractual duty;</strong></li>
        <li><strong>you know is false, misleading, untruthful or inaccurate;</strong></li>
        <li><strong>is unlawful, threatening, abusive, harassing, defamatory, libelous, deceptive, fraudulent, invasive of another's privacy, tortious, obscene, offensive;</strong></li>
        <li><strong>constitutes unauthorized or unsolicited advertising, junk or bulk e-mail ("spamming");</strong></li>
        <li><strong>involves commercial activities and/or sales without Company's prior written consent such as contests, sweepstakes, barter, advertising, or pyramid schemes;</strong></li>
        <li><strong>exploits people in a sexual or violent manner;</strong></li>
        <li><strong>contains software viruses or any other computer codes, files, or programs that are designed or intended to disrupt, damage, limit or interfere with the proper function of any software, hardware, or telecommunications equipment or to damage or obtain unauthorized access to any system, data, password or other information of Company or any third party; or</strong></li>
        <li><strong>impersonates any person or entity, including any employee or representative of Company.</strong></li>
      </ul>

      <p>Additionally, you shall not: (i) take any action that imposes or may impose (as determined by Company in its sole discretion) an unreasonable or disproportionately large load on Company’s (or its third party providers’) infrastructure; (ii) interfere or attempt to interfere with the proper working of the Service or any activities conducted on the Service; (iii) bypass any measures Company may use to prevent or restrict access to the Service (or other accounts, computer systems or networks connected to the Service); (iv) run any form of auto-responder or “spam” on the Service; or (v) use manual or automated software, devices, or other processes to “crawl” or “spider” any page of the Site.<br><br>
      ...
      <h3>
        <a id="5-personal-information" class="anchor" href="#5-personal-information" aria-hidden="true"><span aria-hidden="true" class="link"></span></a>Personal Information.
      </h3>
    ...
    <p>When any user manually deletes their accounts, their personal information is deleted from our servers instantly, and information from deleted accounts by any other user is no longer accessible.  All deleted account information backed up is deleted indefinitely within 7 days.</p>
      ...
      <p>To increase the amount any user wants to charge for Repost Requests (“Repost Price Upgrade”), Users are required to pay annual fee equal to the amount they want to charge.  For example, if a user wants to charge Verified Users $20 to repost Verified User’s content (Albums and/or Merchandise), user must pay Company $20.00 annually.  The maximum repost price upgrade is $1,000,000 USD (one million dollars). The maximum upgrade annual fee is $100,000 USD which is charged to users and paid to Company for any upgrade prices that start at $100,000 USD (one hundred thousand dollars), $250,000 USD (two hundred and fifty thousand dollars), $500,000 USD (five hundred thousand dollars), and $1,000,000 USD (one million dollars).  100% of payments received for Repost Price Upgrades shall be directed to Company.</p>

      <br>

      <h4>Live Video Streaming Cost & Fees.</h4>

      <p>For Live Video Streaming, Verified Users pay $10.00 USD (ten dollars) per hour to Live Video Stream to users.  Verified Users can choose to charge up to $10,000 USD (ten thousand dollars) per user ('Pay Per View') to view their Live Video Stream, payments received from users shall be directed to Verified User, minus 10% of the 'Pay Per View' price which 10% is directed to Company. </p>
      ...
      <p>To enable company to exploit your content, music, products, graphics, and any user uploaded and submitted content, pursuant to the above provisions, you hereby grant to Company the worldwide, non-exclusive, royalty-free, sublicensable, and transferable right to use, distribute, reproduce, copy, and display your trademarks, service marks, slogans, logos or similar proprietary rights (collectively, the “Trademarks”) solely in connection with the Service or in the marketing, promotion or advertising of the service, including in all forms of marketing, promotion, and advertising materials now known or hereafter created.</p>

      <p>By uploading any content the Site:</p>

      <li><strong>Verified Users represent and warrant, and can demonstrate to Company’s full satisfaction upon request, that (i) you own or otherwise control all rights to your Music and Artworks (or that such Music and Artworks are in the public domain or have otherwise been directly licensed to the Verified User in writing with a grant of rights sufficient to permit the Verified User to enter into this Agreement and to grant all of the rights with respect to the Verified User's Music or Artworks as set forth in this Agreement (hereinafter “Direct Licensed”); (ii) you have full authority to act on behalf of any and all owners of any right, title or interest in and to any Music you upload to the Service and to the Artworks; (iii) you have permission to use the name and likeness of each identifiable individual person whose name or likeness is contained or used within the Music and/or Artworks, and to use such individual’s identifying or personal information (to the extent such information is used or contained in the Music and/or Artworks) as contemplated by these Terms of Use, and (iv) you are authorized to grant all of the aforementioned rights to the Music and/or Artworks to Company and all users of the Service.</strong></li>
      ...
      <p>You may contact company at the following address: support@yousound.com.</p>
    </div>
  </div>
</template>
