...
export default {
  ...
  computed: {
    stripeLink () {
      ...
      return `https://connect.stripe.com/oauth/authorize?response_type=code&client_id=${process.env.STRIPE_CONNECT_CLIENT_ID}&scope=read_only&state=${this.$store.state.auth.secret_code}`
    }
  },
