<template>
  <div class="main-section repost-price">
    <div class="description-section">
      ...
      <p class="mt-2">
        Every user can accept $1 and earns 50% of the revenue split.<br />
        Upgrade your price to keep 90% of each repost request.
      </p>
      <ul class="mt-3">
        <li>
          To increase your repost price, you must pay an annual amount equal to
          the price you want to set<br />
          Example: To charge $20 per repost, you must pay $20 per year
        </li>
        <li>
          If you want to increase your price multiple times within an year, your
          cost is prorated
        </li>
        <li>
          If you upgrade your price, you can downgrade your price at any time
        </li>
      </ul>
    </div>
