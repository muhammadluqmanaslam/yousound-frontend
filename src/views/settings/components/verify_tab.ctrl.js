...
export default {
  ...
  created() {
    ...
    Promise.all([UserService.getUserInfo(this.$store.state.auth.user.id)])
      .then((values) => {
      ...
      this.$validator
        ...
        .then((response) => {
          if (response === true) {
            const params = {
              user: {
                ...
                annual_income_on_merch_sales:
                  vm.user.annual_income_on_merch_sales,
                ...
                performance_rights_organization:
                  vm.user.performance_rights_organization,
                ...
                will_sell_music_related_products:
                  vm.user.will_sell_music_related_products,
            ...
            UserService.updateUserInfo(vm.user.id, params)
              .then((response) => {
