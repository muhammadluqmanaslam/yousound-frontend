      ...
      <div class="page-left">
        <div class="tab-container">
          ...
          <div class="shipping-address-section">
            <a
              class="shipping-address-header"
              :class="{ open: showAddress }"
              @click.self="showAddress = !showAddress"
            >
              <div class="arrow"></div>
              ...
              >
                <label
                  >{{ shippingAddress[0].street_1 }}
                  {{ shippingAddress[0].street_2 }}</label
                >
                <label
                  >{{ shippingAddress[0].city }},
                  {{ shippingAddress[0].state }}
                  {{ shippingAddress[0].postcode }}</label
                >
            ...
            <v-layout row>
              ...
              >
                ...
                <div class="product-content">
                  ...
                  <div class="product-content-row justify-space-between pt-2">
                    <div>
                      By
                      <router-link
