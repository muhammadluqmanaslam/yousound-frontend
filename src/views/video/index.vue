<template>
	<div class="page video-page index-page" :class="{isComp}">
		...
		<div class="page-content">
			...
			<v-container fluid :grid-list-md="onMobile" px-0 pt-0 v-if="!viewAllTrendingVideos">
			...
			<v-container v-else fluid :grid-list-md="onMobile" px-0 pt-0>
				<div class="dflex justify-space-between align-center margin-top-x" :style="'margin-top: 90px; margin-bottom: 20px'">
					<div class="text-big">
						Trending Videos
					</div>
					<div class="text-small cursor-pointer">
