<template> 
  <v-card flat>
    <v-layout row wrap class="setting-row pt-5 pb-4"></v-layout>
    <v-layout row wrap class="setting-row">
      <v-flex xs12 sm6><label class="setting-cell-text">Disable Sign Ups</label></v-flex>
      <v-flex xs12 sm6 class="text-xs-right">
        <v-switch hide-details class="setting-cell-switch" v-model="settings.signups"></v-switch>
      </v-flex>
    </v-layout>
    <v-layout row wrap class="setting-row">
      <v-flex xs12 sm6><label class="setting-cell-text">Disable Login</label></v-flex>
      <v-flex xs12 sm6 class="text-xs-right">
        <v-switch hide-details class="setting-cell-switch" label="" v-model="settings.login"></v-switch>
      </v-flex>
    </v-layout>
    <v-layout row wrap class="setting-row">
    ...
    <v-layout row wrap class="setting-row">
      <v-flex xs12 sm6><label class="setting-cell-text">Disable Site For Maintenance</label></v-flex>
      <v-flex xs12 sm6 class="text-xs-right">
        <v-switch hide-details class="setting-cell-switch" label="" v-model="settings.maintenance"></v-switch>
      </v-flex>
    </v-layout>
    <v-layout row wrap class="setting-row">
      <v-flex xs12 sm6><label class="setting-cell-text">Send All Users Direct Message</label></v-flex>
    </v-layout>
    <v-layout row wrap class="setting-row">
      <v-flex xs12>
        <v-text-field
